...
const LIB_LOG_JS_TAG        =  LIB_LOG_JS_ID +" (220120:19h:04)";
/*}}}*/
...
let log_object_val_format = function(val,lxx)
{
    ...
    if     (               val instanceof HTMLElement) text = log_json(val, lxx);
...
const STYLE_BG_TOP=[];
      STYLE_BG_TOP [1] = " background:linear-gradient(to bottom, #964B00 0%, rgba(34,34,34,0.1) 100%); border-bottom: 2px solid #964B00;";
      STYLE_BG_TOP [2] = " background:linear-gradient(to bottom, #FF0000 0%, rgba(34,34,34,0.1) 100%); border-bottom: 2px solid #FF0000;";
      STYLE_BG_TOP [3] = " background:linear-gradient(to bottom, #FFA500 0%, rgba(34,34,34,0.1) 100%); border-bottom: 2px solid #FFA500;";
      STYLE_BG_TOP [4] = " background:linear-gradient(to bottom, #FFFF00 0%, rgba(34,34,34,0.1) 100%); border-bottom: 2px solid #FFFF00;";
      STYLE_BG_TOP [5] = " background:linear-gradient(to bottom, #9ACD32 0%, rgba(34,34,34,0.1) 100%); border-bottom: 2px solid #9ACD32;";
      STYLE_BG_TOP [6] = " background:linear-gradient(to bottom, #6495ED 0%, rgba(34,34,34,0.1) 100%); border-bottom: 2px solid #6495ED;";
      STYLE_BG_TOP [7] = " background:linear-gradient(to bottom, #EE82EE 0%, rgba(34,34,34,0.1) 100%); border-bottom: 2px solid #EE82EE;";
      STYLE_BG_TOP [8] = " background:linear-gradient(to bottom, #A0A0A0 0%, rgba(34,34,34,0.1) 100%); border-bottom: 2px solid #A0A0A0;";
...
const STYLE_BG_BOT=[];
      STYLE_BG_BOT [1] = " background:linear-gradient(to    top, #964B00 0%, rgba(34,34,34,0.1) 100%); border-top   : 2px solid #964B00;";
      STYLE_BG_BOT [2] = " background:linear-gradient(to    top, #FF0000 0%, rgba(34,34,34,0.1) 100%); border-top   : 2px solid #FF0000;";
      STYLE_BG_BOT [3] = " background:linear-gradient(to    top, #FFA500 0%, rgba(34,34,34,0.1) 100%); border-top   : 2px solid #FFA500;";
      STYLE_BG_BOT [4] = " background:linear-gradient(to    top, #FFFF00 0%, rgba(34,34,34,0.1) 100%); border-top   : 2px solid #FFFF00;";
      STYLE_BG_BOT [5] = " background:linear-gradient(to    top, #9ACD32 0%, rgba(34,34,34,0.1) 100%); border-top   : 2px solid #9ACD32;";
      STYLE_BG_BOT [6] = " background:linear-gradient(to    top, #6495ED 0%, rgba(34,34,34,0.1) 100%); border-top   : 2px solid #6495ED;";
      STYLE_BG_BOT [7] = " background:linear-gradient(to    top, #EE82EE 0%, rgba(34,34,34,0.1) 100%); border-top   : 2px solid #EE82EE;";
      STYLE_BG_BOT [8] = " background:linear-gradient(to    top, #A0A0A0 0%, rgba(34,34,34,0.1) 100%); border-top   : 2px solid #A0A0A0;";

...
const LIB_POPUP_JS_TAG        =  LIB_POPUP_JS_ID +" (210701:17h:11)";
/*}}}*/
...
let log_popup      = function(message_HTML, xy/*=LOG_POPUP_XY     */, style=LOG_POPUP_STYLE     )
{
    /* CREATE {{{*/
    if(!log_popup_div)
        log_popup_div_get();
...
//logXXX("log_popup: DISPLAY")
    ...
    if( xy )
    {
//      if(xy.y > 0) log_popup_div.classList.add("above");
...
/*{{{
:e C:/LOCAL/STORE/DEV/PROJECTS/RTabs/Util/RTabs_Profiles/DEV/javascript/dom_popup.js
}}}*/

...
const LIB_POPUP_JS_TAG        =  LIB_POPUP_JS_ID +" (220218:15h:22)";
/*}}}*/
...
/* onload {{{*/
//console.log("%c"+LIB_POPUP_JS_TAG+": LOADING", "color:lime; font-size:200%;");
try { module.exports = lib_popup; } catch(ex) { /*console.log(ex);*/ } /* server.js require */ /* eslint-disable-line no-undef */

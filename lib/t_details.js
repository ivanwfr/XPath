...
const T_DETAILS_JS_TAG = T_DETAILS_JS_ID    +" (211026:16h:26)";
/*}}}*/
...
/*➔ t_details_onload {{{*/
let t_details_onload = function()
{
/*{{{*/
if( log_this) console.log("t_details_onload");
//  console.trace()//FIXME
/*}}}*/
...
{
console.log("details_radio_set_from_localStorage");//FIXME
...
if(log_this) console.log(" ➔ %c PROPAGATE SAME OPEN STATE TO OTHERS [open "+details_sibling_open_state+"]", "background-color: "+(details_sibling_open_state ?  "#080":"#880"));// FIXME
    }
    /*}}}*/

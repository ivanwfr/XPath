...
/* exported xpath_postgres, XPATH_POSTGRES_JS_TAG */

const XPATH_POSTGRES_JS_ID  = "xpath_postgres";
const XPATH_POSTGRES_JS_TAG = XPATH_POSTGRES_JS_ID+" (211014:19h:44)";    // eslint-disable-line no-unused-vars
/*}}}*/

let xpath_postgres = (function() {
"use strict";
...
{
    /* [pending_queries] {{{*/
    if(!pending_queries || !pending_queries.length)
    {
if(config.LOG_MORE)
...
try { module.exports = xpath_postgres; } catch(ex) {} /* server.js require */
